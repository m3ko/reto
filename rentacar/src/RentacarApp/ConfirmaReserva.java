...
public class ConfirmaReserva {
	...
	public static int precioTotalAux;
	 ...
	 * @author Niko
	 * 
	 *         El usuario, podrá verificar los datos seleccionados, podrá escoger
	 *         opciones referentes al seguro y el precio total de la reserva. Y se
	 *         guardará en un objeto el precioTotal.
	 */
...
//		    frame.setDefaultLookAndFeelDecorated(true);
		...
		cerrar.addActionListener(new ActionListener() {
			/**
			 * @param e al presionar este botón, se cerrará el programa.
			 */
		...
		submit.addActionListener(new ActionListener() {
			/**
			 * @param e Si presiona el botón submit le llevará a la sigueinte ventana.
			 */
			public void actionPerformed(ActionEvent e) {
		...
		btnVolver.addActionListener(new ActionListener() {
			/**
			 * @param e Si se presiona este botón, se volverá a la ventana anterior.
			 */
			public void actionPerformed(ActionEvent e) {
