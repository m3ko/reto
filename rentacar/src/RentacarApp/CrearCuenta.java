...
public class CrearCuenta {
	 ...
	 * @author niko
	 * 
	 *         El usuario podrá crear una nueva cuenta
	 */
...
//		    frame.setDefaultLookAndFeelDecorated(true);
		...
		submit.addActionListener(new ActionListener() {
			/**
			 * @param e El usuario ingresará los datos y se comprobara si ya hay un usuario
			 *          existente con esos datos, y si la contraseña coincide con el campo
			 *          de "repetir contraseña"
			 */
		...
		btnVolver.addActionListener(new ActionListener() {
			/**
			 * @param e Si el usuario presiona este botón, volverá a la ventana anterior.
			 */
			public void actionPerformed(ActionEvent e) {
				Login.main(null);
				frame.dispose();
