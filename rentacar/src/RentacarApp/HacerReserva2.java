...
public class HacerReserva2 {
	 ...
	 * @author niko
	 * 
	 *         El usuario escogerá el tipo de coche que querrá reservar.
	 */
...
//    frame.setDefaultLookAndFeelDecorated(true);
		...
		cerrar.addActionListener(new ActionListener() {
			/**
			 * @param e Al presionar el botón cerrar, se le cerrará el programa.
			 */
		...
		btnNext.addActionListener(new ActionListener() {
			/**
			 * @param e El usuario al presionar este botón, irá al paso siguiente.
			 */
			public void actionPerformed(ActionEvent e) {
		...
		btnVolver.addActionListener(new ActionListener() {
			/**
			 * @param e Al presionar el boton volver, volverá a la ventana anterior.
			 */
			public void actionPerformed(ActionEvent e) {
		...
		compactButton.addActionListener(new ActionListener() {
			/**
			 * @param e Al seleccionar el boton compact, se guadará el valor en la variable
			 *          "carroceria";
			 */
			public void actionPerformed(ActionEvent e) {
		...
		coupeButton.addActionListener(new ActionListener() {
			/**
			 * @param e Al seleccionar el boton coupe, se guadará el valor en la variable
			 *          "carroceria";
			 */
			public void actionPerformed(ActionEvent e) {
		...
		sedanButton.addActionListener(new ActionListener() {
			/**
			 * @param e Al seleccionar el boton sedan, se guadará el valor en la variable
			 *          "carroceria";
			 */
			public void actionPerformed(ActionEvent e) {
		...
		hibridoButton.addActionListener(new ActionListener() {
			/**
			 * @param e Al seleccionar el boton hibrido, se guadará el valor en la variable
			 *          "carroceria";
			 */
			public void actionPerformed(ActionEvent e) {
		...
		deportivoButton.addActionListener(new ActionListener() {
			/**
			 * @param e Al seleccionar el boton deportivo, se guadará el valor en la
			 *          variable "carroceria";
			 */
			public void actionPerformed(ActionEvent e) {
		...
		suvButton.addActionListener(new ActionListener() {
			/**
			 * @param e Al seleccionar el boton SUV, se guadará el valor en la variable
			 *          "carroceria";
			 */
			public void actionPerformed(ActionEvent e) {
		...
		camionetaButton.addActionListener(new ActionListener() {
			/**
			 * @param e Al seleccionar el boton camioneta, se guadará el valor en la
			 *          variable "carroceria";
			 */
			public void actionPerformed(ActionEvent e) {
		...
		minivanButton.addActionListener(new ActionListener() {
			/**
			 * @param e Al seleccionar el boton minivan, se guadará el valor en la variable
			 *          "carroceria";
			 */
			public void actionPerformed(ActionEvent e) {
